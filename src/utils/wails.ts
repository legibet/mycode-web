...
import type { WorkspaceFilesResponse } from "./completion";
...
interface WailsApp {
  ...
  CompactSession(
    sessionId: string,
    req: { provider?: string | undefined; model?: string | undefined },
  ): Promise<APIResult<CompactResponse>>;
  ...
  WorkspaceFiles(
    ...
    dir: string,
    prefix: string,
  ): Promise<APIResult<WorkspaceFilesResponse>>;
}
...
export const wailsAPI = {
  ...
  compactSession(
    ...
    return call("CompactSession", "Failed to compact session", sessionId, req);
  },
